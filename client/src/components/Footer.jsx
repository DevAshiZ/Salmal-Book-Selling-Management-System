...
import logoImg from "../images/logoBnW.svg";
      ...
      <div className="mx-auto w-full max-w-7xl px-3">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <img
            ...
            className="pt-12 mx-auto md:mx-0"
          />
          {!isMobile && (
            <div className="mx-auto grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-8">
